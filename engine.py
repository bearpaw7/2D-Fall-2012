...
class Engine:
    ...
    def __init__(self):
        ...
        text = font.render("Tanks - engine", True, black)
        ...
        while engineExit==False:
            ...
            for event in pygame.event.get(): # User did something
                ...
                if event.type == pygame.QUIT or (event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE):
                    engineExit = True # Flag that we are done so we exit this loop
...
if __name__ == '__main__':
    print '\'engine.py\' is not the correct startup script'
    print 'Attempting to execute main.py...'
    try:
        execfile('main.py')
    finally:
        print 'Exited engine.py'
